...
// Spannung+Raumtemperatur+Heizbetttemperatur+Betriebsmodus+Zieltemperatur+Fehlercode
...
void loop() {
  ...
  #ifdef SOFTSERIAL
  bluetoothCounter = (bluetoothCounter==10000) ? 0 : ++bluetoothCounter;
  #endif
